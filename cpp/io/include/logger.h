...
enum LogLevel { DEBUG, INFO, WARNING, ERROR, MSG };

enum LogFlags { ENDL, TIME };
...
public:
  ...
  static inline std::string logLevelColorize(LogLevel level,
...
#define LOG(Level) _LOG << io::LogLevel::Level

#define LOG_T(Level) _LOG << io::LogLevel::Level << io::LogFlags::TIME
